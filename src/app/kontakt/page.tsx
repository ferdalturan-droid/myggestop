...
export const generateMetadata = () =>
  buildMetadata({
    ...
    description: "Kontakt Myggestop. Vi leverer til hele Danmark og tilbyder montering i Kobenhavn og omegn. Ring eller skriv til os.",
    path: "/kontakt"
  });
  ...
  return (
    <section className="bg-mesh section">
      <div className="container-page">
        <SectionHeading eyebrow="Kontakt" title="Vi sidder klar til at hjaelpe dig" text="Har du sporgsmal om mal, produkter, levering eller montering? Sa hor endelig fra os." />
        <div className="mt-12 grid gap-8 lg:grid-cols-[1fr_1.1fr]">
          <div className="space-y-5">
            ...
            <div className="card p-6">
              <h3 className="font-bold text-brand-ink">Serviceomrade</h3>
              <div className="mt-4 space-y-3">
                <p className="flex items-start gap-3 text-brand-ink2">
                  ...
                  <span><strong>Vi leverer til hele Danmark.</strong> Bestil online og fa dine specialfremstillede net leveret til doren.</span>
                </p>
                <p className="flex items-start gap-3 text-brand-ink2">
                  ...
                  <span><strong>Montering tilbydes i Kobenhavn og omegn.</strong> Vaelg montering i bestillingen, sa klarer vi opsaetningen.</span>
                </p>
              </div>
            </div>
          </div>
